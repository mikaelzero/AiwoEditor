        ...
        switch (callbackId) {
            ...
            case CALLBACK_IMAGE_TAP:
                ...
                if (mediaMeta != null) {
                    ...
                    try {
                        ...
                        String classes = getString(mediaMetaJson, "classes");
            ...
            case CALLBACK_RESPONSE_STRING:
                ...
                if (params.startsWith("function=") && params.contains(JS_CALLBACK_DELIMITER)) {
                    ...
                    switch (functionName) {
                        case "getAllHTMLForCallback":
                            responseIds.add("title");
                            responseIds.add("content");
                            responseIds.add("images");
                            responseIds.add("editorStatus");
                            break;
                        case "getImagesForCallback":
                        case "getHTMLForCallback":
                        case "getEditorStatusForCallback":
                            responseIds.add("id");
